...
// Conditions mirrors the AWS IAM condition block:
//
...
//	}
//
// Evaluation (performed by the engine) follows AWS semantics: operators AND
...
// Values is a set of condition values. To mirror AWS it unmarshals from either
