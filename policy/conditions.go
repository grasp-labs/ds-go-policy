...
// Conditions is the condition block:
//
...
//	}
//
// Evaluation (performed by the engine): operators AND together, keys within an
// operator AND together, and the values for a single key OR together. The data
// model here only carries the block; it assigns no meaning to operator names.
